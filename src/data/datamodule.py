...
class ODEDataModule(LightningDataModule):
    """`LightningDataModule` for the LF dataset.
    ...
    def __init__(
        self,
        data_dir: str = "data/",
        train_val_test_split: Tuple[int, int, int] = (4096, 512, 512),
        batch_size: int = 64,
        num_workers: int = 0,
        ...
        self.ode_target = target(dt, t_step, dim)

        self.dataset = self.prepare_data()

    def prepare_data(self) -> TensorDataset:
